...
streamlit.text('🍌🍇 Banana-Grape Smoothie')
streamlit.text('🍌🥭 Banana-Mango Smoothie')
streamlit.text('🥝🍇 Pineapple-Grape Smoothie')
streamlit.text('🥝🥭 Pineapple-Mango Smoothie')
...
#import snowflake.connector
streamlilt.header("The fruit load list contains:")
...
# allow the end user to add a fruit to the lis
